...
Detects duplicate images within a directory using perceptual hashing (pHash)
which can identify similar images even with minor modifications like resizing,
compression, or color adjustments.

Dependencies:
    Pillow, imagehash (installed via conda environment)

Usage:
    from plantnet.images.deduplication import deduplicate_species_images
